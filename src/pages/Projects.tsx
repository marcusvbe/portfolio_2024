...
const Projects: React.FC = () => {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      image: api_Chamados,
      detalhes: `O projeto integrado do 2º semestre de 2023 consistiu na criação de uma aplicação de gestão de chamados de TI. 
      Nossa equipe optou por desenvolvê-la direcionada a escolas e instituições de ensino para a gestão de chamados relativos a problemas de software. 
      O sistema tem 3 níveis de acesso diferentes: cliente, técnico e administrador.`,
      ...
      contribuicoes: ["Desenvolvi a API rest: criação de rotas e operações de CRUD", "Implementei a lógica de funcionamento do sistema, como as mudanças de status do chamado refletindo ações do cliente, do técnico e do admin.", "Fiz integrações com o frontend."],
    ...
    },
    {
      ...
      image: COVID_proj,
      detalhes: `Projeto do API (Aprendizagem por Projeto Integrado) do 1º semestre do curso de Desenvolvimento de Software Multiplataforma da FATEC de São José dos Campos – SP, em parceria com a TV Vanguarda. 
      O site permite analisar e comparar alguns dados de saúde do sistema Datasus (Tabnet) a fim de identificar possíveis impactos da Covid longa em 3 cidades do Vale do Paraíba: São José dos Campos, Jacareí e Taubaté.`,
        ...
        <Modal.Body>
          {selectedProject && (
            <>
              ...
              <p className="project-details">{selectedProject.detalhes}</p>
